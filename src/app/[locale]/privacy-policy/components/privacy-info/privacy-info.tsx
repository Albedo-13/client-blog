    ...
    <section className={styles.section}>
      <div className="container">
        ...
        <p className={styles.text}>
          ...
          ultrices gravida dictum fusce ut placerat orci nulla. Neque convallis a cras semper auctor neque vitae tempus
          quam.
        </p>
        ...
        <p className={styles.text}>
          ...
          Volutpat blandit aliquam etiam erat velit. Orci eu lobortis elementum nibh. Ipsum suspendisse ultrices gravida
